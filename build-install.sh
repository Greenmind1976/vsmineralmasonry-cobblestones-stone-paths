...
###############################################################################
# Build + Install VSMineralMasonry.CobblestonesStonePaths into Vintage Story 1.21.7
###############################################################################
...
PROJECT_NAME="VSMineralMasonry.CobblestonesStonePaths"
PROJECT_PATH="$ROOT_DIR/$PROJECT_NAME.csproj"
MOD_ID="vsmineralmasonrycobblespaths"
